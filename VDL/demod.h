...
#define F0 84000
#define Fs 10500
#define MAXerror 2147483647
#define Ntap 2048
#define NtapT 128 //число элементов линии задержки полифазного фильтра
#define KoefI 16  //КОЭФФИЦИЕНТ ИНТЕРПОЛЯЦИИ ПОЛИФАЗНОгО ФИЛЬТРА
#define DCgain  65536
#define L_uniqueWord 18
using namespace std;
